...
// HTTP behaviour is covered in olxvn_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "olxvn://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("olxvn", "about")
	if err != nil || got.String() != "olxvn://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want olxvn://page/about", got.String(), err)
	}
}
